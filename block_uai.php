...
class block_uai extends block_base {
    ...
    protected function emarking() {
        ...
        $root["newprintorder"]["icon"]	 = "e/insert_file";
        ...
        $root["myexams"]["icon"]   = "i/calendareventdescription";
    ...
    protected function reserva_salas() {
        ...
        if(has_capability("local/reservasalas:administration", $context) ||
            ...
            if(has_capability("local/reservasalas:administration", $context)) {
                ...
                $root["settings"]["rooms"]["icon"] =   "i/log";
                ...
                $root["settings"]["buildings"]["icon"] =   "i/log";
                ...
                $root["settings"]["campus"]["icon"] =   "i/log";
                ...
                $root["settings"]["resources"]["icon"] =   "i/log";
            }
            ...
            if(has_capability("local/reservasalas:bockinginfo", $context)) {
                ...
                $root["settings"]["userbooks"]["icon"] =   "i/log";
                ...
                $root["settings"]["diagnostic"]["icon"] =	"i/log";
            }
            ...
            if(has_capability("local/reservasalas:blocking", $context)) {
                ...
                $root["settings"]["usersettings"]["icon"] = "i/user";
                ...
                $root["settings"]["usersettings"]["block"]["icon"] =   "i/log";
                ...
                $root["settings"]["usersettings"]["unblock"]["icon"] =	 "i/log";
            }
    ...
    protected function paperattendance() {
        ...
        if(has_capability("local/paperattendance:upload", $context) || $is_secretary || has_capability("local/paperattendance:upload", $context_system)){
            $root["upload"] = array();
            ...
            $root["upload"]["icon"] = 	"e/new_document";
        }
        ...
        if(has_capability("local/paperattendance:printsearch", $context) || $is_secretary || has_capability("local/paperattendance:printsearch", $context_system)){
            $root["search"] = array();
        ...
        if(has_capability("local/paperattendance:missingpages", $context) || $is_secretary || has_capability("local/paperattendance:missingpages", $context_system)){
            $root["missing"] = array();
